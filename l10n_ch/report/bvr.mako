...
<head>
   ...
   <body topmargin="0px">
    ...
    %endif
     <table name="bvrframe"  id="${inv.id}" style="width:210mm;height:85mm;border-collapse:collapse;padding-left:3mm;font-family:Helvetica;font-size:8pt;border-width:0px" border="0" CELLPADDING="0" CELLSPACING="0"> <!--border-width:1px;border-style:solid;border-color:black;-->
        ...
        <tr style="height:16.933333mm;vertical-align:bottom;padding-bottom:0"><td><table style="padding-left:3mm;font-family:Helvetica;font-size:8pt" height="100%"><tr style="vertical-align:top;padding-bottom:0"><td>${user.company_id.partner_id.address[0].street}<br/> ${user.company_id.partner_id.address[0].zip} ${user.company_id.partner_id.address[0].city}</td></tr><tr style="vertical-align:bottom;padding-bottom:0"><td><div style="padding-left:30.48mm;">${inv.partner_bank_id.print_account and inv.partner_bank_id.post_number or ''}</div></td></tr></table></td><td style="padding-left:3mm"><table style="padding-left:3mm;font-family:Helvetica;font-size:8pt" height="100%"><tr style="vertical-align:top;padding-bottom:0"><td>${user.company_id.partner_id.address[0].street}<br/>${user.company_id.partner_id.address[0].zip} ${user.company_id.partner_id.address[0].city}</td></tr><tr style="vertical-align:bottom;padding-bottom:0"><td><div style="padding-left:30.48mm;">${inv.partner_bank_id.print_account and inv.partner_bank_id.post_number or ''}</div></td></tr></table></td><td style="text-align: right;padding-right:4mm;padding-bottom:10mm;font-size:11pt">${_space(_get_ref(inv))}</td></tr>
		%if inv.partner_bank_id.print_partner : 
        <tr style="height:16.933333mm;vertical-align:top;padding-top:0"> <td style="padding-top:4mm"><table  style="width:100%" CELLPADDING="0" CELLSPACING="0"><td  style="width:4mm"></td><td style="width:40mm;text-align: right;font-size:11pt" >${_space(('%.2f' % inv.amount_total)[:-3], 1)}</td><td style="width:6mm"></td><td style="width:10mm;text-align: right;font-size:11pt">${ _space(('%.2f' % inv.amount_total)[-2:], 1)}</td><td style="width:5mm;text-align: right"></td></table></td><td style="padding-top:4mm"><table  style="width:100%" CELLPADDING="0" CELLSPACING="0"><td  style="width:4mm"></td><td style="width:40mm;text-align: right;font-size:11pt" >${_space(('%.2f' % inv.amount_total)[:-3], 1)}</td><td style="width:6mm"></td><td style="width:10mm;text-align: right;font-size:11pt">${ _space(('%.2f' % inv.amount_total)[-2:], 1)}</td><td style="width:3mm;text-align: right"></td></table></td><td style="width:40mm;padding-left:26mm;text-align: left;padding-top:4mm"> ${inv.partner_id.name}<br/>${inv.partner_id.address[0].street}<br/>${inv.partner_id.address[0].zip} ${inv.partner_id.address[0].city} </td></tr>
		%else:
        <tr style="height:16.933333mm;vertical-align:top;padding-top:0"> <td style="padding-top:4mm"><table  style="width:100%" CELLPADDING="0" CELLSPACING="0"><td  style="width:4mm"></td><td style="width:40mm;text-align: right;font-size:11pt" >${_space(('%.2f' % inv.amount_total)[:-3], 1)}</td><td style="width:6mm"></td><td style="width:10mm;text-align: right;font-size:11pt">${ _space(('%.2f' % inv.amount_total)[-2:], 1)}</td><td style="width:3mm;text-align: right"></td></table></td><td><table  style="width:100%" CELLPADDING="0" CELLSPACING="0"><td  style="width:4mm"></td><td style="width:40mm;text-align: right;font-size:11pt" >${_space(('%.2f' % inv.amount_total)[:-3], 1)}</td><td style="width:6mm"></td><td style="width:10mm;text-align: right;font-size:11pt">${ _space(('%.2f' % inv.amount_total)[-2:], 1)}</td><td style="width:3mm;text-align: right"></td></table></td><td></td></tr>
		%endif
        %if inv.partner_bank_id.print_partner :
        <tr style="height:16.933333mm;vertical-align:bottom;padding-bottom:0"> <td><table  style="padding-left:3mm;font-family:Helvetica;font-size:8pt; width:100%" CELLPADDING="0" CELLSPACING="0"><td  style="width="100%";padding-left:3mm;text-align: left">${_space(_get_ref(inv))}<br/> ${inv.partner_id.name}<br/>${inv.partner_id.address[0].street}<br/>${inv.partner_id.address[0].zip} ${inv.partner_id.address[0].city}  </td><td></td><td></td><td></td><td></td></table></td><td><table><td></td><td></td><td></td><td></td><td></td></table></td><td></td></tr>
        %else:
        <tr style="height:16.933333mm"><td></td><td></td><td></td></tr>
        %endif
    </table>
    %endfor
</body>
